...
public class Eventfr extends Fragment implements View.OnClickListener {
    ...
    private void hitAPI() {
        ...
        if (UtilMethods.INSTANCE.isNetworkAvialable(getActivity())) {
            UtilMethods.INSTANCE.eventApi(getActivity(), loader);
        } else {
            ...
            if (GalleryList != null) {
                ...
                if (GalleryList.getMessage().size() > 0) {
                    ...
                    for (int i = 0; i < GalleryList.getMessage().size(); i++) {
                        ...
                        tv.setText(GalleryList.getMessage().get(i).getEvent_date() + "  " + GalleryList.getMessage().get(i).getEvent_name());
